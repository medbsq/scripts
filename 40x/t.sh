...
#cat 4xxpayloads | httpx -silent -status-code -content-length -H "X-Forwarded-For: 127.0.0.1" -H "X-Forwarded-Host: 127.0.0.1" -H "X-Custom-IP-Authorization: 127.0.0.1" | grep -v $conlen | grep "\[.*200.*\]"
